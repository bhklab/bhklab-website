...
const labsocials = require('./api/data/labsocials')


// data routes
router.get('/data/datasets', dataset.getAll);
router.post('/data/datasets/deleteOne/:id', auth.verifyToken, dataset.deleteOne);
...
router.post('/data/researches/deleteOne/:id',auth.verifyToken, research.deleteOne);

router.get('/data/socials', social.getAll);
router.post('/data/socials/deleteOne/:id', social.deleteOne);

router.get('/data/lab-socials/links', labsocials.getAll);
