const researchAxisDescription = {
	Pharmacogenomics: {
		...
		description: `Through the joint analysis of molecular and pharmacological profiles of cancer cells, 
	...
	Radiomics: {
		...
		description: `Radiological imaging offers a distinctive perspective on tumors and their macro- and microenvironment, 
		providing valuable non-invasive insights. Widely employed in clinical settings, 
		this technology generates vast amounts of data that we strive to leverage for the development of novel computational models. 
		Our objective is to harness this rich data to enhance diagnosis, treatment planning, and the prediction of therapy response and resistance.`,
		imagePath: '/images/research/biomarker.png',
	},

	'Multimodal Data Integration': {
		'research-axis': 'Multimodal Data Integration',
		description: `As technologies become more accessible, their utilization in research and clinical settings opens up new avenues for 
	...
	'Software Development': {
		...
		description: `Scientific software is a vital pillar of modern research. However, the development of robust software packages, databases, and web applications 
	...
	'Open Science': {
		...
		description: `We embrace the Open science principles through a collaborative and transparent approach to scientific research that 
		emphasizes the free and unrestricted access to scientific knowledge, data, methodologies, and research outputs. 
